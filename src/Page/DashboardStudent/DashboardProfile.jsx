        ...
        <main className="min-w-0 flex-1">
          ...
          <div className="mx-auto w-full max-w-7xl px-5 py-10 sm:px-8 lg:px-10 lg:py-12">
            ...
            <div className="mt-6 rounded-2xl border border-gold/10 bg-gold/[0.03] px-5 py-4">
              <p className="text-sm font-bold leading-7 text-white text-center">
                هذه الصفحة مخصصة لعرض بيانات الحساب الحالية فقط. كلمة المرور لا
                يتم عرضها ضمن بيانات الملف الشخصي.
              </p>
            </div>
          </div>
        </main>
