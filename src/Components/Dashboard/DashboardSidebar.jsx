    ...
    <>
      ...
      <aside
        className={`
          ...
          xl:sticky xl:top-0 xl:z-[200] xl:w-64 xl:translate-x-0
        `}
      >
        ...
        <div className="border-t border-white/10 p-4 absolute bottom-0 left-0 right-0">
          <button
            ...
            className="flex w-full cursor-pointer items-center gap-3 rounded-xl bg-red-400/10 px-4 py-3 text-sm font-bold duration-300 hover:gap-4 hover:bg-red-600/75"
          >
